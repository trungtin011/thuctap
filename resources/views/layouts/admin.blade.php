        ...
        <div class="flex flex-1 min-h-0">
            ...
            <aside class="w-64 bg-indigo-700 text-white flex-shrink-0 flex flex-col">
                ...
                <nav class="flex-1 p-4 space-y-2">
                    ...
                    <a href="{{ route('admin.financial.index') }}" class="block px-3 py-2 rounded hover:bg-indigo-800">Chấp nhận đơn</a>

                    <!-- Thêm dòng sau để xem tổng doanh thu -->
                    <a href="{{ route('admin.financial.total_revenue') }}" class="block px-3 py-2 rounded hover:bg-indigo-800 font-semibold text-yellow-300">
                        Xem tổng doanh thu
                    </a>
                </nav>
