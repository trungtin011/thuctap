...
<body class="bg-gray-50 font-sans">
    <div class="min-h-screen flex flex-col">
                ...
                <nav class="nav-menu hidden md:flex items-center space-x-4">
                    ...
                    @auth
                        <div class="relative">
                            ...
                            <div
                                class="dropdown-menu absolute right-0 mt-2 w-40 bg-white text-gray-800 shadow-lg rounded-lg overflow-hidden z-50">
        ...
        <main class="flex-grow container mx-auto px-4 py-4">
            @if (session('success'))
                <div
                    class="alert bg-green-100 border-l-4 border-green-500 text-green-700 p-3 mb-4 rounded-lg shadow-sm text-sm">
                    {{ session('success') }}
                </div>
            @endif
            @if (session('error'))
                <div
                    class="alert bg-red-100 border-l-4 border-red-500 text-red-700 p-3 mb-4 rounded-lg shadow-sm text-sm">
                    {{ session('error') }}
                </div>
            @endif
            @yield('content')
        ...
        <footer class="bg-gradient-to-r from-indigo-900 to-gray-900 text-white py-6">
            ...
            <button onclick="scrollToTop()"
                class="back-to-top fixed bottom-4 right-4 bg-indigo-600 text-white p-2 rounded-full shadow-lg hover:bg-indigo-500 opacity-70 hover:opacity-100">
