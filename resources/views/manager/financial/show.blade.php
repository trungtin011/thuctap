...
@section('content')
    ...
    <div class="mx-auto px-4 py-6">
        @if ($financialRecord && $financialRecord->submittedBy->email === 'kinhdoanh@gmail.com')
            ...
            <div class="space-y-3 text-gray-700 mb-6 p-4 border border-gray-300 rounded-lg bg-gray-50 flex flex-col">
                ...
                <div class="">
                    ...
                    {{ $financialRecord->route ? $financialRecord->route->name : 'N/A' }}
                </div>
                <div class="">
                ...
                <div class="">
                    <strong><i class="fas fa-desktop text-blue-500 mr-2"></i>Nguồn doanh thu:</strong>
                    {{ $financialRecord->platform->name ?? 'N/A' }}
                </div>
                <div class="">
                ...
                <table class="w-full border border-gray-300 text-sm text-left text-gray-700">
                    <thead class="bg-gray-100 text-gray-800">
                        <tr>
                            ...
                            <th class="border px-4 py-2"><i class="fas fa-route mr-1"></i>Tuyến</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{ $financialRecord->route ? $financialRecord->route->name : 'N/A' }}</td>
                            <td class="border px-4 py-2">{{ number_format($totalExpense) }}</td>
                            <td class="border px-4 py-2">{{ number_format($financialRecord->commission) }} VND</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        @else
            <div class="alert alert-danger">
                <i class="fas fa-exclamation-triangle"></i> Bạn không có quyền truy cập bản ghi này.
            </div>
        @endif
    </div>
