...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body">
        <form id="financialForm" action="{{ route('employee.financial.store.' . ($isMarketing ? 'marketing' : ($isAccountant ? 'accounting' : 'business'))) }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="bank_transfer" class="form-control" step="0.01" min="0" required>
                ...
                <div class="revenue-source-row mb-3 p-3 border rounded">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="number" name="revenue_sources[0][cash]" class="form-control" step="0.01" min="0" required>
                            <div class="invalid-feedback"></div>
                        </div>
            ...
            <button type="button" class="btn btn-outline-secondary mb-3" onclick="addRevenueSourceRow()">Thêm nguồn doanh thu</button>
            @elseif ($isBusiness)
            <h6 class="mb-3">Nguồn Doanh Thu</h6>
            <div id="revenue-source-container">
                <div class="revenue-source-row mb-3 p-3 border rounded">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <input type="number" name="revenue_sources[0][commission]" class="form-control" step="0.01" min="0" required>
                            <div class="invalid-feedback"></div>
                        </div>
            ...
            <div id="expense-container">
                <div class="expense-row mb-3 p-3 border rounded">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            <label class="form-label">Số tiền</label>
                            <input type="number" name="expenses[0][amount]" class="form-control" step="0.01" min="0" required>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-md-4 mb-2">
        ...
        newRow.innerHTML = `
            <div class="row">
                ...
                @if ($isAccountant)
                    <div class="col-md-4 mb-2">
                        <label class="form-label">Tiền mặt</label>
                        <input type="number" name="revenue_sources[${revenueSourceIndex}][cash]" class="form-control" step="0.01" min="0" required>
                        <div class="invalid-feedback"></div>
                    </div>
                @else
                    <div class="col-md-3 mb-2">
            ...
            .then(data => {
                if (data.success) {
                    Swal.fire({
                        ...
                        window.location.href = ''; // Sửa lại redirect về trang index
                    });
                } else {
